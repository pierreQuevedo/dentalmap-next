  ...
  return (
    <>
      {React.Children.map(children, (child) => {
        ...
        // `props` est `unknown` avec les types React 19 : le typer ici est la
        // seule adaptation, le comportement reste celui de la source.
        const enfant = child as React.ReactElement<
        ...
        return React.cloneElement(enfant, {
          ...
          className: cn(className, enfant.props.className),
          ...enfant.props,
        });
      })}
    </>
